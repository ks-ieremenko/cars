                ...
                <div className={styles.carContainer}>
                    <div>
                        ...
                        <p>
                            ...
                            автомобілем. <br />
                            Також необхідно буде залишити завдаток у розмірі 500
                            – 700 $ залежно від категорії обраного вами авто.
                            Після закінчення терміну оренди ми повертаємо
                            завдаток у повному розмірі, окрім порушень, за які
                            можна начислити штраф. <br />
                            <br />
